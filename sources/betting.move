module suibets::betting {
    ...
    // Settle a SUI bet with AdminCap (admin can also settle)
    ...
    // Mint a new OracleCap for a settlement oracle
    ...
    // Revoke an OracleCap by burning it (oracle must send it back)

...
export default function SportsExact() {
  useEffect(() => {
    ...
    sportsButton.style.left = '439px'; // Precisely aligned with 'Sports' text
    ...
    sportsButton.style.width = '65px'; // Exactly the width of 'Sports' text
    sportsButton.style.height = '40px'; // Taller for better clickability
    ...
    liveButton.style.left = '509px'; // Precisely aligned with 'Live' text
    ...
    liveButton.style.width = '47px'; // Exactly the width of 'Live' text
    liveButton.style.height = '40px'; // Taller for better clickability

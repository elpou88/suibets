...
export default function NewLive() {
  useEffect(() => {
    ...
    // Add the Sports navigation area - exact position in the mockup, use direct assign for more reliable navigation
    ...
    // Add the Promotions navigation area - Use window.location.assign for more reliable navigation

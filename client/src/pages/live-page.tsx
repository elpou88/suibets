...
export default function LivePage() {
  useEffect(() => {
    ...
    img.src = '/images/live-image.png';
    img.alt = 'Live Events Page';
    img.style.width = '100%';
    img.style.height = 'auto';
    img.style.display = 'block';
    
    // Handle image load events
    img.onload = () => console.log('Live image loaded successfully');
    img.onerror = () => console.error('Failed to load live image');
    ...
    img.addEventListener('click', (e) => {
      ...
      if (y < 50) {
        ...
        if (x >= 450 && x <= 475) {
          ...
          // Live area - already on this page
          console.log('Live link clicked (already on this page)');
        } else if (x >= 560 && x <= 620) {
          // Promotions area

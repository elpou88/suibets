...
export default function SportsPage() {
  useEffect(() => {
    ...
    img.src = '/images/sports-image.png';
    img.alt = 'Sports Page';
    img.style.width = '100%';
    ...
    img.onload = () => console.log('Sports image loaded successfully');
    img.onerror = () => console.error('Failed to load sports image');
    ...
    img.addEventListener('click', (e) => {
      ...
      if (y < 50) {
        ...
        if (x >= 450 && x <= 475) {
          // Sports area - already on this page
          console.log('Sports link clicked (already on this page)');
        } else if (x >= 500 && x <= 530) {
          // Live area
